...
class TestFormTagHelper(WebHelpersTestCase):
    ...
    def test_radio_button(self):
        ...
        self.assertEqual(
            radiobutton("people", u'josé', checked=True),
            u'<input checked="checked" id="people_jos" name="people" type="radio" value="jos&#233;" />'
        )
    ...
    def test_submit(self):
        ...
        self.assertEqual(
            u'<input name="commit" onclick="return confirm(\'Are you sure?\');" type="submit" value="Save" />',
            submit("Save", confirm='Are you sure?')
        )
        self.assertEqual(
            u'<input name="commit" onclick="alert(\'Clicked!\');return confirm(\'Are you sure?\');" type="submit" value="Save" />',
        ...
        self.assertEqual(
            u'<input name="commit" onclick="this.disabled=true;this.value=\'Saving...\';this.form.submit();alert(\'hello!\')" type="submit" value="Save" />',
